...
public final class ProductPatterns {
    ...
    public static final String PRODUCT_TITLE_PATTERN = "^[A-ZА-ЯІЇЄ][A-Za-zА-Яа-яІіЇїЄє0-9\\s'’.,()\\-+/&\":%]+$";
    public static final String PRODUCT_TITLE_VALIDATION_MESSAGE = "Title must start with a capital letter and may contain only letters, numbers, spaces, and common punctuation characters.";
